...
public class PurchaseController {
    ...
    @GetMapping("/totalSum")
    public ResponseEntity<Long> getTotalSum(@RequestParam Map<String, String> purchases) {
        return ResponseEntity.ok(purchaseService.getTotalSum(purchases));
    }

    @PostMapping
    public ResponseEntity<HttpStatus> purchase(@RequestBody Map<String, String> purchases, @RequestParam Long totalSum)
